...
namespace engine
{
    ...
    public:
		...
		int32_t physical_object_index() const { return m_physical_object_index; }
		...
		void set_physical_object_index(int32_t index) { m_physical_object_index = index; }
		...
		void set_angular_factor_lock(bool angular_factor_lock) { s_lock_angular_factor = angular_factor_lock; }
